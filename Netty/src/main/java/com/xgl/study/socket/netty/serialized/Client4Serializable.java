 ...
 * 4. connect连接服务，并发起请求
 */
package com.xgl.study.socket.netty.serialized;

import java.util.Random;
import java.util.concurrent.TimeUnit;

import com.xgl.study.socket.utils.GzipUtils;
import com.xgl.study.socket.utils.RequestMessage;
import com.xgl.study.socket.utils.SerializableFactory4Marshalling;
